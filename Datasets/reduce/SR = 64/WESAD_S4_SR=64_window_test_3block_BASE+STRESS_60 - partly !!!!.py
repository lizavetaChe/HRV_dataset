...
res3_test = nk.signal_resample(res1, sampling_rate=700, desired_sampling_rate=64, method='interpolation')
res4_test = nk.signal_resample(res2, sampling_rate=700, desired_sampling_rate=64, method='interpolation')
...
peaks_s_1, info_s_1 = nk.ecg_peaks(signals_ECG_stress_1, sampling_rate=64)
peaks_s_2, info_s_2 = nk.ecg_peaks(signals_ECG_stress_2, sampling_rate=64)
peaks_s_3, info_s_3 = nk.ecg_peaks(signals_ECG_stress_3, sampling_rate=64)

# nk.hrv(peaks_s_1, sampling_rate=256, show=True)
# plt.show()

hrv_indices_s_1 = nk.hrv(peaks_s_1, sampling_rate=64, show=True)
print('STRESS_1: \n', hrv_indices_s_1)
hrv_indices_s_2 = nk.hrv(peaks_s_2, sampling_rate=64, show=True)
print('STRESS_2: \n', hrv_indices_s_2)
hrv_indices_s_3 = nk.hrv(peaks_s_3, sampling_rate=64, show=True)
print('STRESS_3: \n', hrv_indices_s_3)
...
signals_ECG_base_1, info_ECG_base_1 = nk.ecg_process(ECG_base_1, sampling_rate=64)
signals_ECG_base_2, info_ECG_base_2 = nk.ecg_process(ECG_base_2, sampling_rate=64)
signals_ECG_base_3, info_ECG_base_3 = nk.ecg_process(ECG_base_3, sampling_rate=64)

# nk.ecg_plot(signals_ECG_stress, info_ECG_stress)
# plt.show()

peaks_b_1, info_b_1 = nk.ecg_peaks(signals_ECG_base_1, sampling_rate=64)
peaks_b_2, info_b_2 = nk.ecg_peaks(signals_ECG_base_2, sampling_rate=64)
peaks_b_3, info_b_3 = nk.ecg_peaks(signals_ECG_base_3, sampling_rate=64)

# nk.hrv(peaks_s, sampling_rate=256, show=True)
# plt.show()

hrv_indices_b_1 = nk.hrv(peaks_b_1, sampling_rate=64, show=True)
print('BASE_1: \n', hrv_indices_b_1)
hrv_indices_b_2 = nk.hrv(peaks_b_2, sampling_rate=64, show=True)
print('BASE_2: \n', hrv_indices_b_2)
hrv_indices_b_3 = nk.hrv(peaks_b_3, sampling_rate=64, show=True)
print('BASE_3: \n', hrv_indices_b_3)
