...
print(first_point, end_point)
ECG_stress = res3_test[first_point:end_point].copy()
signals_ECG_stress, info_ECG_stress = nk.ecg_process(ECG_stress, sampling_rate=64)
#nk.ecg_plot(signals_ECG_stress, info_ECG_stress )
#plt.show()
peaks_s, info_s = nk.ecg_peaks(signals_ECG_stress, sampling_rate=64)
# nk.hrv(peaks_s, sampling_rate=256, show=True)
# plt.show()
hrv_indices_s = nk.hrv(peaks_s, sampling_rate=64, show=True)
print('STRESS: \n', hrv_indices_s)